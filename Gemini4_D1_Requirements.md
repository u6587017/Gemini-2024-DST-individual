...
-	ระบบสนับสนุนการวิเคราะห์ข้อมูล (Data Analysis)
...
-	นักพัฒนาซอฟต์แวร์มีข้อจำกัดที่ต้องปฏิบัติตามแนวทางการควบคุมการตั้งค่าอย่างเคร่งครัดเพื่อหลีกเลี่ยงผลกระทบต่อการทำงานปกติผู้ดูแลระบบสามารถเข้าถึงแบบ Observing, Maintenance และ Test Levels ได้
